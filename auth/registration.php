...
<head>
    <meta charset="UTF-8">
    <?php include('../includes/header_pwa.php'); ?> <title>Registration | SMS</title>
        <style>
        ...
        * { box-sizing: border-box; font-family: 'Inter', sans-serif; margin: 0; padding: 0; outline: none; }
        ...
        .auth-container {
            ...
            padding: 30px; border-radius: 12px; width: 100%; max-width: 680px;
            box-shadow: 0 10px 25px rgba(0, 0, 0, 0.05);
        }

        h2 {
            text-align: left; margin-bottom: 25px; font-size: 24px; font-weight: 700;
            color: #1e293b; border-left: 5px solid #0284c7; padding-left: 15px;
        }
        ...
        .file-box {
            border: 1px dashed #cbd5e1; padding: 15px; border-radius: 8px;
            text-align: center; color: #64748b; font-size: 13px; cursor: pointer;
            transition: 0.3s; position: relative; background: #f8fafc;
        }

        .file-box:hover { border-color: #0284c7; background: #f0f9ff; color: #0284c7; }

        .submit-btn {
            padding: 14px; background: #0284c7; color: #ffffff; border: none; 
